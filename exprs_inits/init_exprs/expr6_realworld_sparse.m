...
dataset_names = ["enron" "uber" "chicago" "chicago_2019"];
ranks = [10 21 10 10];
dataset_paths = {enron_path, uber_path, chi_path, chi_2019_path};
...
% save results
results_filename = sprintf('results/expr6_RW_%dtensor_%dinits_%druns_cp_opt_', num_tensors, num_inits, ...

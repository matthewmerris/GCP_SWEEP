...
hold on;
for i = 1:num_losses
    objs_plot = plot(log10(amino_objectives(:,i)), 'LineStyle','none','Marker','o');
...
hold on;
for i = 1:num_losses
    fits_plot = plot(amino_fits(:,i), 'LineStyle','none','Marker','o');
...
hold on;
for i = 1:num_losses
    cossims_plot = plot(amino_cossims(:,i), 'LineStyle','none','Marker','o');
...
hold on;
for i = 1:num_losses
    corcondias_plot = plot(amino_corcondias(:,i), 'LineStyle','none','Marker','o');
...
log_corcondias = amino_corcondias;
...
%% best results table
ID = losses';
OBJ = best_amino_objectives;
FIT = best_amino_fits;
COSSIM = best_amino_cossims;
CORCON = best_amino_corcondias;
